  ...
  const insertInitialData = async () => {
    ...
    if (count === 0) {
      const initialData = [
        ...
        { title: "Expenditure relief for 3 months", amount: 0, rate: 0 },
        {
          title: "Income tax first 2,250,000 for 9 months",
          amount: 0,
          rate: 6,
        },
        {
          title: "Income tax next 2,250,000 for 9 months",
          amount: 0,
          rate: 12,
        },
        {
          title: "Income tax (remain balance)balance for 9 months",
          amount: 0,
          rate: 18,
        },
        ...
        {
          title: "Tax on terminal benefits 0 – 10,000,000",
          amount: 0,
          rate: 0,
        },
        {
          title: "Tax on terminal benefits 10,000,000 – 20,000,000",
          amount: 0,
          rate: 6,
        },
        {
          title: "Tax on terminal benefits exceeding 20,000,000",
          amount: 0,
          rate: 12,
        },
      ];
